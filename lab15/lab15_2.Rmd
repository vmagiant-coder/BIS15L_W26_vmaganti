...
ui <- fluidPage(
    ...
    selectInput("x",
              "Select Order",
              choices = sort(unique(gestation$order)), #looks into order variable and pulls out all possible orders without typing them, and sort puts them in order
...
ui <- dashboardPage(
  ...
  dashboardBody(
    ...
    selectInput("x",
              "Select Population",
              choices = sort(unique(wolves$pop)), #looks into order variable and pulls out all possible orders without typing them, and sort puts them in order
              selected = "AK.PEN"),
