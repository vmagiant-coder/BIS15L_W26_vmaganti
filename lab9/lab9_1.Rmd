...
ggplot(data = heartrate,
       mapping=aes(x=)) #CANT MAKE A PLOTTTT
```
...
ggplot(aes(x=drug, y=heartrate)) +
  ...
  labs(title="Drug Administered vs Heartrate", x = "Drug Administered", y = "Heartrate")
```
...
relig_income_long <- relig_income %>%
   pivot_longer(-religion,
               ...
               values_to= "total") #move the count to a new column
relig_income_long
```
...
billboard %>%
  pivot_longer(
    cols=starts_with("wk"),
    names_to = "week",
    names_prefix = "wk", #gets rid of the wk, makes it week
    values_to = "rank",
    values_drop_na = T
  )
```
