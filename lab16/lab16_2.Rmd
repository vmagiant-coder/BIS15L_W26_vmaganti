...
#copy url and paste it in google to see the top accession, click summary, and assembly, download the genome annotation and download as a table
```
...
```{r}
#unknown amino acid file, blast it through the website
```
...
```{r}
#read.csv("data/blast_result/blastp_results")
```
