...
```{r}
sum(is.na(homerange))
filter(homerange, thermoregulation == "ectotherm")
```
There are 2945 NA values.
...
ggplot(data = homerange,
  ...
  geom_point() +
labs(title="Body Mass vs. Homerange Size", x= "Body Mass", y= "Homerange Size") +
scale_y_log10() +
scale_x_log10()
```
fish %>%
...
Which species that walk or fly have the largest homeranges?
```{r}
homerange %>%
